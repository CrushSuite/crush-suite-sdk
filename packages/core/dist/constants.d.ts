...
export declare const CRUSH_SUITE_NAMESPACE = "app--94371610625--crush_suite";
export declare const LEGAL_AGE_FOR_ALCOHOL = 21;
export declare const CRUSHSUITE_SHIPPING_STATE: "CRUSHSUITE_SHIPPING_STATE";
export declare const CRUSHSUITE_AGE_VERIFIED: "CRUSHSUITE_AGE_VERIFIED";
export declare const CRUSHSUITE_CUSTOMER_DEFAULT_ADDRESS: "CRUSHSUITE_CUSTOMER_DEFAULT_ADDRESS";
export declare const CRUSHSUITE_CUSTOMER_DOB: "CRUSHSUITE_CUSTOMER_DOB";
